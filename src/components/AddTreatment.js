...
import { treatmentTypes, treatmentAssessments, treatmentPlaceholder, smallMedia } from "../config";

export const AddTreatment = () => {
    const [loading, setLoading] = useState(false);
    const [patient, setPatient] = useState();
    const [error, setError] = useState("");
    const [formInputs, setFormInputs] = useState(treatmentPlaceholder);
    ...
    async function handleSubmit(e) {
        ...
        const newTreatment = { ...formInputs, treatmentId: nanoid() };

        // Create a new treatment_entries array
        const newTreatmentEntries = sortTreatmentsByDate([...patient.treatment_entries, newTreatment]);
    ...
    return (
        <div className="h-auto py-5 px-3">
            <h1 className="text-center mb-5">เพิ่มรายการการดูแล</h1>
